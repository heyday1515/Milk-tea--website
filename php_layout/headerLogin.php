...
<div class="wrap">
	<div class="header">
		<div class="header-1">
			...
			<a class="gio" href="me.php" style="position: relative; left: -100px; top: -401px;"><?php echo $_SESSION['Name'];?></a>
			<a class="gio" href="Logout.php" style="position: relative; left: 50px; top: -401px;">Logout</a>
